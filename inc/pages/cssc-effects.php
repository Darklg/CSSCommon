...
<section class="block-content centered-container">
    <div>
        ...
        <p>
            <a href="#demo-appear-load" class="cssc-button show-html-button">Afficher HTML</a>
            <a href="#cssc-effects-appear" class="cssc-button relaunch-effect">‣ Relancer</a>
        </p>
...
&lt;/p&gt;</pre>
        ...
        <p>
            <a href="#demo-slide-load" class="cssc-button show-html-button">Afficher HTML</a>
            <a href="#cssc-effects-slide" class="cssc-button relaunch-effect">‣ Relancer</a>
        </p>
...
<section class="block-content centered-container">
    <div>
        ...
        <p><a href="#demo-cssc-inverted-hover" class="cssc-button show-html-button">Afficher HTML</a></p>
...
&lt;/p&gt;</pre>
        ...
        <p><a href="#demo-cssc-colorized-hover" class="cssc-button show-html-button">Afficher HTML</a></p>
