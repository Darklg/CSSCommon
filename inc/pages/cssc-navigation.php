            ...
            <div class="cssc-navbar--search">
                <form action="#" method="post" onsubmit="return false;">
                    <div>
                        ...
                        <button type="submit" class="cssc-button cssc-button--default">search</button>
                    </div>
                </form>
            </div>
        ...
        <ul class="cssc-mainmenu">
            ...
            <li class="withsubmenu">
                ...
                <div class="submenu trans-opa">
                    <ul>
                        <li><a href="#">Template HTML</a></li>
                        <li><a href="#">Template WordPress</a></li>
                        <li><a href="#">Template Magento</a></li>
                        <li><a href="#">Template Newsletter</a></li>
                        <li><a href="#">Template Mobile</a></li>
                    </ul>
                </div>
            </li>
